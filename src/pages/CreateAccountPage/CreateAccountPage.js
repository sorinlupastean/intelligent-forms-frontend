...
import { ReactComponent as Account_name_logo } from "../../assets/account.svg";
        ...
        <div className={CreateAccountPageCSS.cover}>
          ...
          <div className={CreateAccountPageCSS.signup_inputs}>
            <div className={CreateAccountPageCSS.container_input}>
              <Account_name_logo className={CreateAccountPageCSS.inputs_logo} />
          ...
          <button className={CreateAccountPageCSS.signup_btn}>SIGN UP</button>
          <p className={CreateAccountPageCSS.signin_text}>
            Already have an account?
            <Link to="/SignInPage" className={CreateAccountPageCSS.signin_link}>
              Sign in
            </Link>
          </p>
        </div>
